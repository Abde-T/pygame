...
class BG(pygame.sprite.Sprite):
    def __init__(self, groups, scale_factor):
        ...
        bg_image = pygame.image.load("Flappy Bird/graphics/environment/background.png").convert()
...
class Ground(pygame.sprite.Sprite):
    def __init__(self, groups, scale_factor):
        ...
        #image
        ground_surface = pygame.image.load("Flappy Bird/graphics/environment/ground.png").convert_alpha()
...
class Plane(pygame.sprite.Sprite): 
    def __init__(self, groups, scale_factor):
       ...
       #mask
        ...
        #sound
        self.jump_sound = pygame.mixer.Sound('Flappy Bird/sounds/jump.wav')
        self.jump_sound.set_volume(0.2)

    def import_frames(self, scale_factor):
        self.frames = []
        for i in range(3):
            surf = pygame.image.load(f'Flappy Bird/graphics/plane/red{i}.png').convert_alpha()
